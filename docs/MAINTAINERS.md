...
This page mirrors the repository's root `MAINTAINERS.md`. Keep the two in sync.
...
- **Security issues:** [SECURITY.md](https://github.com/DavidLangworthy/jobtree/blob/main/SECURITY.md) — use GitHub's private
  vulnerability reporting. No email address is published, and none is needed.
- **Everything else:** open a GitHub issue.

## Contributions

**Not currently accepted.** [No licence is granted](https://github.com/DavidLangworthy/jobtree/blob/main/LICENSE) for this code, so
