...
| [R4](R4-plugin-hotpath.md) | Permit hot-path relists + unbounded ledger replay | ✅ | ◐ pt1 done (hot-path metrics); pt1b caching + pt2 compaction pending | ◐ unit+race; caching/bench deferred |
