		...
		Budgets: []v1.Budget{
			{
				...
				Spec: v1.BudgetSpec{
					...
					Envelopes: []v1.BudgetEnvelope{{
						...
						Flavor:      "H100-80GB",
						Selector:    map[string]string{topology.LabelRegion: "us-west", topology.LabelCluster: "cluster-a", topology.LabelFabricDomain: "island-a"},
						Concurrency: 96, Start: &testWindowStart, End: &testWindowEnd,
					}},
				},
			},
			{
		...
		Budgets: []v1.Budget{
			{
				...
				Spec: v1.BudgetSpec{
					...
					Envelopes: []v1.BudgetEnvelope{{
						...
						Flavor:      "H100-80GB",
						Selector:    map[string]string{topology.LabelRegion: "us-west", topology.LabelCluster: "cluster-a", topology.LabelFabricDomain: "island-a"},
						Concurrency: 64, Start: &testWindowStart, End: &testWindowEnd,
					}},
				},
			},
			{
		...
		Budgets: []v1.Budget{{
			...
			Spec: v1.BudgetSpec{
				...
				Envelopes: []v1.BudgetEnvelope{{
					...
					Flavor:      "H100-80GB",
					Selector:    map[string]string{topology.LabelRegion: "us-west", topology.LabelCluster: "cluster-a", topology.LabelFabricDomain: "island-a"},
					Concurrency: 256, Start: &testWindowStart, End: &testWindowEnd,
				}},
			},
		}},
	}
		...
		Budgets: []v1.Budget{{
			...
			Spec: v1.BudgetSpec{
				...
				Envelopes: []v1.BudgetEnvelope{{
					...
					Concurrency: 16, Start: &testWindowStart, End:
